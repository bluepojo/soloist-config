#!/usr/bin/env bash
GITHUB_NAME="bluepojo"
SOLOISTDIR="${HOME}/soloistgo"
SOLOISTRC_URL="https://raw.github.com/${GITHUB_USER}/soloist-config/master/soloistrc"
CHEFFILE_URL="https://raw.github.com/${GITHUB_USER}/soloist-config/master/Cheffile"
